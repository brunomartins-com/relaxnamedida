...
elixir(function(mix) {
    ...
    mix.scripts(['bootstrap.js', 'custom.js', 'jquery.validate.min.js', 'jquery.mask.min.js', 'jquery.easing.min.js', 'wz_tooltip.js'], '../public_html/concursonamedida/assets/js/main.min.js');

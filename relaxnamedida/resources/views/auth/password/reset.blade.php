            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                ...
                <div class="block block-themed animated fadeIn">
                    ...
                    <div class="block-content block-content-full block-content-narrow">
                        <img src="{{ asset('assets/images/logo-concurso-relax-na-medida.png') }}" alt="Concurso Relax Na Medida - 12ª Edição" class="center-block" width="80%" />
                        ...
                        <form class="js-validation-recovery form-horizontal push-50-t push-50" action="{!! action('Auth\PasswordController@postReset') !!}" method="post">
                            {!! csrf_field() !!}

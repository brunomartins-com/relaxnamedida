...
// constructor for validator
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            maxlength: $.validator.format("Não insira mais que {0} characteres."),
            minlength: $.validator.format("Insira pelo menos {0} characteres."),
            rangelength: $.validator.format("Insira entre {0} e {1} characteres."),

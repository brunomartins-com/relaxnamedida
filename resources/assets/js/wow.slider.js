...
function ws_caption_parallax(t, n, i, a, s, o) {
    ...
    n.parent().css({
        ...
        if (u*=c / 100, t.prevIdx == t.curIdx)
            p(n, 0).fadeIn(o / 3), p(e(">div,>span", n), 0);
        else {
...
function ws_caption_slide(t, e, o, i) {
    ...
    function a(t, e, o) {
        for (var i = "padding-left|padding-right|border-left-width|border-right-width".split("|"), a = 0, n = 0; n < i.length; n++)
            a += parseFloat(r(t, i[n])) || 0;
    ...
    function n(t, e, o) {
        for (var i = "padding-top|padding-bottom|border-top-width|border-bottom-width".split("|"), a = 0, n = 0; n < i.length; n++)
            a += parseFloat(r(t, i[n])) || 0;
...
!function() {
    ...
    e.extend(e.easing, {
        ...
        function r(t) {
            ...
            if ("transparent" == t && (t = "rgba(255,255,255,0)"), e = /^#([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})/.exec(t))
                ...
                if (!(e = /^rgb\(([\d]+),([\d]+),([\d]+)\)/.exec(t)))
                    throw Error(t + " is not supported by $.parseColor");
                e = [ + e[1], + e[2], + e[3]]
            }
        ...
        function s(t, e, i) {
            ...
            o.push(e);
            for (var n in o)
                o[n] = (4 == t.length ? "rgba(" : "rgb(") + o[n].join(",") + ")";
            return o
        }
        function d(t, i) {
            if (!t ||!t.length)
        ...
        ]][Math.floor(4 * Math.random())], u = function() {
...
jQuery.fn.wowSlider = function(t) {
    ...
    function r(t) {
        for (var e = "", n = 0; n < t.length; n++)
            e += String.fromCharCode(t.charCodeAt(n)^1 + (t.length - n)%7);
        return e
    }
    function c(n, i, a) {
        if (!Z) {
            if (i)
                void 0 != a && (K = a^t.revers), e(n);
            else {
                if (Z)
                    return;
                te=!1, function(e, n, i) {
    ...
    function y() {
        function e(t) {
            if (!r) {
                ...
                for (var e = .2, n = 0; 2 > n; n++) {
                    if (n)
                        var c = a.find("> a"), l = i ? a.width(): k(c.get(0)).outerWidth(!0) * c.length;
                    else
                        var l = a.height();
                    ...
                    if (0 > f) {
                        ...
                        if (a.css({
                            ...
                            d = f * Math.min(Math.max((h - e) / (1 - 2 * e), 0), 1), p =- _e * l / 2;
                        a.animate(n ? {
                            left: d
                        } : {
                            top: d
        ...
        if (fe.length) {
            ...
            if (g.length) {
                var b = k('<div class="ws_bulframe"/>').appendTo(m), y = k("<div/>").css({
                    width: g.length + 1 + "00%"
    ...
    function x(t) {
        k("A", de).each(function(e) {
            if (e == t) {
                ...
                k(this).removeClass("ws_selthumb")
        })
    }
    function _(t) {
    ...
    z.each(function() {
        for (var t = k(">img:first,>iframe:first,>iframe:first+img,>a:first,>div:first", this), e = k("<div></div>"), n = 0; n < this.childNodes.length;)
    ...
    if (ie && (ie = r(ie))) {
        ...
        if (Ce) {
            if (k(Ce).insertAfter(A), window.Audio && Ce.canPlayType && Ce.canPlayType("audio/mp3"))
                Ce.loop = "loop", t.autoPlay && (Ce.autoplay = "autoplay", setTimeout(function() {
                    Ce.play()
                }, 100));
            else {
                Ce = Ce.src;
...
(function($) {
    ...
    var effectsPath = ('assets/js/effects/');
    ...
    $.fn.wowSlider = function (options) {
        ...
        $.getScript(effectsPath + newOptions.effect + ".js", function() {
            ...
            if (newOptions.effect == 'brick')
                newOptions.duration = 5500;
            else
